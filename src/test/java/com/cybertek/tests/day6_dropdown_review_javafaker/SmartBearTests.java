...
public class SmartBearTests {
    ...
    public void task2_create_order_with_javafaker() throws InterruptedException {
        ...
        quantityInput.sendKeys(Keys.BACK_SPACE);  // BACK_SPACE is deleted first index(ele) 02 ->2 deleted 0;
        Thread.sleep(1000);
        ...
        // locating all of the web ele using id
        ...
        WebElement successMassage = driver.findElement(By.xpath("//strong"));
        Assert.assertTrue(successMassage.isDisplayed(),"success message not display");
